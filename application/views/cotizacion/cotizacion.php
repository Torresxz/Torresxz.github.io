      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-12">
            ...
            <!-- ========== CONTENIDO ========== -->
            <div id="test-list" class="card" data-toggle="lists" data-options='{"valueNames": ["orders-fecha", "orders-cliente", "orders-tiempoE", "orders-subtotal", "orders-lugar"],"page":10,"pagination":"true"}'>
                  ...
                  <div class="col-auto">
                    ...
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 20px, 0px);">
                        <a class="dropdown-item sort" data-sort="orders-fecha" href="#!">
                          Asc
                        </a>
                        <a class="dropdown-item sort" data-sort="orders-fecha" href="#!">
                          Desc
                ...
                <table class="table table-sm table-nowrap card-table">
                  <thead>
                    <tr>
                      ...
                      <th>
                        <a href="#" class="text-muted sort" data-sort="orders-cliente">
                          Cliente
                        </a>
                      </th>
                      <th>
                        <a href="#" class="text-muted sort" data-sort="orders-tiempoE">
                          Tiempo de entrega
                        </a>
                      </th>
                      <th>
                      ...
                      <th>
                        <a href="#" class="text-muted sort" data-sort="orders-lugar">
                          Lugar de servicio
                        </a>
                      </th>
                      <th></th>
                  ...
                  <tbody class="list">
                    <?php foreach ($cotizacion as $key => $cotizacion) { ?>
                      ...
                      <tr>
                        ...
                        <td class="orders-cliente">
                         <?php foreach ($clientes as $key => $cliente) { 
                           
                            if($cliente->idcliente==$cotizacion->idcliente){
                        ...
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              <a href="<?=base_url('cotizacion/editar_cotizacion/'.$cotizacion->Idcotizacion)?>" class="dropdown-item">
                                Editar
                              </a>
                              <a href="<?=base_url('cotizacion/cotizacion_eliminar/'.$cotizacion->Idcotizacion)?>" class="dropdown-item">
                                Eliminar
                              </a> 
                               <a href="<?=base_url('cotizacion/cotizacion_pdf/'.$cotizacion->Idcotizacion)?>" class="dropdown-item">
                                Ver
                              </a> 
