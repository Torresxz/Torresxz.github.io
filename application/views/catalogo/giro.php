              ...
              <div class="card" data-toggle="lists" data-options='{"valueNames": ["orders-order", "orders-product", "orders-date", "orders-total", "orders-status", "orders-method"]}'>
                  <div class="card-header">
                      <div class="row align-items-center">
                          ...
                          <div class="col-auto">
                              <!-- Button -->
                              <a href="<?=base_url('catalogo/agregar_giro')?>"class="btn btn-primary btn-sm">
                                  Agregar Giro
                              </a>
                          </div>
                      </div> <!-- / .row -->
                                  ...
                                  <td class="text-right">
                                      <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-right">
                                              <a href="editar_giro/<?=$giro->idGiro?>" class="dropdown-item">
                                                  Editar
                                              </a>
                                              <a href="eliminar_giro/<?=$giro->idGiro?>" class="dropdown-item">
                                                  Eliminar
                                              </a>
                                          </div>
                                      </div>
