              ...
              <div class="card" data-toggle="lists" data-options='{"valueNames": ["orders-order", "orders-product", "orders-date", "orders-total", "orders-status", "orders-method"]}'>
                  <div class="card-header">
                      <div class="row align-items-center">
                          ...
                          <div class="col-auto">
                              <!-- Button -->
                              <a href="<?=base_url('catalogo/agregar_tipo_anuncio')?>"class="btn btn-primary btn-sm">
                                  Agregar Tipo Anuncio
                              </a>
                          </div>
                      </div> <!-- / .row -->
                  </div>
                  <div class="table-responsive">
                      <table class="table table-sm table-nowrap card-table">
                          ...
                          <tbody class="list">
                          <?php foreach ($tipo_anuncios as $key => $anuncio) { ?>
                              <tr>
                                  <td>
                                      <div class="custom-control custom-checkbox table-checkbox">
                                  ...
                                  <td class="text-right">
                                      <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-right">
                                              <a href="editar_tipo_anuncio/<?=$anuncio->idAnuncio?>" class="dropdown-item">
                                                  Editar
                                              </a>
                                              <a href="eliminar_tipo_anuncio/<?=$anuncio->idAnuncio?>" class="dropdown-item">
                                                  Eliminar
                                              </a>
                                          </div>
                                      </div>
