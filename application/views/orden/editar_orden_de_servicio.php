        ...
        <div class="row justify-content-center">
          <div class="col-12 col-12 col-lg-12 col-xl-12">
            ...
            <div class="card">
              <div class="card-body">
                <!-- Form -->
                <?=form_open('orden/editar_orden_de_servicio/'.$ordenservicio->idordenservicio)?>
                        ...
                        <label>
                          ...
                          <div class="col-12 col-md-4">
                              <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="input_idservicio"  step="0.01" min="0"  value="<?php echo $ordenservicio->idordenservicio;?>">
                            ...
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" name="input_observaciones" value="<?php echo $ordenservicio->Observaciones;?>"></input>
                  ...
                  <div class="form-group">
                      ...
                      <input type="date" class="form-control form-control-lg" name="input_Fecha" value="<?php echo $ordenservicio->fechaprogramacion;?>"></input>
