      ...
      <div class="container-fluid">
        <div class="row justify-content-center">
          <div class="col-12">
            ...
            <!-- ========== CONTENIDO ========== -->
            <div id="test-list" class="card" data-toggle="lists" data-options='{"valueNames": ["orders-id", "orders-nombre", "orders-admin"],"page":10,"pagination":"true"}'>
              <div class="card-header">
                <div class="row align-items-center">
                  ...
                  <div class="col-auto">
                    <!-- Button -->
                    <a href="<?=base_url('trabajo/areas_agregar')?>"class="btn btn-primary btn-sm">
                      Agregar areas
                    </a>
                  </div>
                </div> <!-- / .row -->
              ...
              <div class="table-responsive">
                <table class="table table-sm table-nowrap card-table">
                  ...
                  <tbody class="list">
                    <?php foreach ($areas_trabajo as $key => $areas_trabajo) { ?><!-- ambas son variables-->
                      <tr>
                        <td>
                          <div class="custom-control custom-checkbox table-checkbox">
                        ...
                        <td class="orders-id">
                            <?=$areas_trabajo->idarea?>
                        </td>
                        <td class="orders-nombre">
                           <?=$areas_trabajo->nombrearea?>
                        </td>
                        <td class="orders-admin">
                          <?=$areas_trabajo->descripcionarea?>
                        </td>
                        ...
                        <td class="text-right">
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                              <a href="<?=base_url('trabajo/areas_editar/'.$areas_trabajo->idarea)?>" class="dropdown-item">
                                Editar
                              </a>
                              <a href="<?=base_url('trabajo/areas_eliminar/'.$areas_trabajo->idarea)?>" class="dropdown-item">
                                Eliminar
                              </a> 
