                            ...
                            <?php foreach ($servicios as $key => $servicios) { ?>
                                <tr>
                                    ...
                                    <td class="orders-nombre">
                                        <?=$servicios->nombre.' '.$servicios->apellidos?>
                                    </td>
                                    <td class="orders-admin">
                                        <?=$servicios->admin?>
                                    </td>
                                    <td class="orders-grupo">
                                        <?php foreach ($servicios->grupos as $keyy => $grupo) {
                                            echo '<span class="badge badge-soft-secondary">'.$grupo->titulo.'</span> ';
                                        }?>
                                    </td>
                                    <td class="orders-status">
                                        <div class="badge badge-pill <?php if($servicios->active=='Activo'){ echo 'badge-success'; }else{ echo 'badge-secondary'; }  ?>">
                                            <?=$servicios->active?>
                                        </div>
                                    </td>
                                    <td class="text-right">
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a href="<?=base_url('servicio/servicios_editar/'.$servicios->usuario_id)?>" class="dropdown-item">
                                                    Editar
                                                </a>
                                                <a href="<?=base_url('servicio/servicios_eliminar/'.$servicios->usuario_id)?>" class="dropdown-item">
                                                    Eliminar
                                                </a>
                                            </div>
                                        </div>
