...
class Historial extends CI_Controller
{
    ...
    {
        $data['historial'] = $this->{$this->model}->listar_usuarios();

        foreach ($data['historial'] as $key => $usuario) {
        ...
        $this->load->view($this->views.'historial',$data);
    }
    // -------------------------------------------------------------------
     ...
     * @return  Void
     */
    public function historial_agregar()
    {
        ...
        $this->load->view($this->views.'agregar_historial');
