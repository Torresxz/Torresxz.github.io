 ...
 *
 * @author Erick Campos Cortes / Universidad Politécnica de Tlaxcala
 *
 */
class TrabajoA extends CI_Controller
{

    private $views = 'TrabajoA/';
    ...
    public function TrabajoA()
    {
        ...
        $this->load->view($this->views.'TrabajoA',$data);
    }
    // -------------------------------------------------------------------
    ...
    public function areas_trabajo()
    {
        ...
        $this->load->view($this->views.'areas_trabajo');
