...
/**
 *-------------------------------------------------------------------------
 * Modulo de configuración de areas de trabajo
 * ------------------------------------------------------------------------
 *
 * Modulo que permite configurar y agregar las diferentes areas de trabajo
 *
 * @author Miriam Beristain / Universidad Politécnica de Tlaxcala
 *
 */
class Fecha_Calibracion extends CI_Controller
{

    private $views = 'Fecha_Calibracion/';
     ...
     * @return  Void
     */
    public function Fecha_Calibracion()
    {
        ...
        $this->load->view($this->views.'Fecha_Calibracion',$data);
    }
    // -------------------------------------------------------------------
     ...
     * @return  Void
     */
    public function Fecha_Calibrar()
    {
        
        $this->load->view($this->views.'Fecha_Calibrar');
