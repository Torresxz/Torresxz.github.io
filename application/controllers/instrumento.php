...
class instrumento extends CI_Controller
{
    ...
    {
        $this->load->view($this->views.'agregar_inst');
    }
    // --------------------------------------------------<-----------------
     ...
     * @return  Void
     */
    public function ListaInstrumentos()
    {
        $data['instru'] = $this->{$this->model}->listar_usuarios();

        foreach ($data['instru'] as $key => $usuario) {
        ...
        $this->load->view($this->views.'instrumentos',$data);
    }
    // -------------------------------------------------------------------
     ...
     * @return  Void
     */
    public function Instrumento_agregar()
    {
        /*
